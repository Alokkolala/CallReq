...
```
curl -X POST http://26.25.202.146:8000/upload_csv \
  -F "file=@transactions.csv" -o scored_transactions.csv
...
Invoke-RestMethod -Method Post -Uri http://26.25.202.146:8000/upload_csv -Form @{file=Get-Item "data\new_transactions.csv"} -OutFile scored_transactions.csv
```
